...
async function migrate() {
  for (const stmt of [
    ...
    `ALTER TABLE products ADD COLUMN IF NOT EXISTS last_quality_check_at  TIMESTAMPTZ   DEFAULT NULL`,
    `CREATE INDEX IF NOT EXISTS idx_products_quality_visible ON products(is_public_visible) WHERE is_public_visible = true`,
