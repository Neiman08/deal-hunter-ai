    ...
    <div className="space-y-6 animate-fade-in">
      ...
      {user?.plan === 'free' && (
        <div className="p-4 bg-orange-500/10 border border-orange-500/20 rounded-xl flex items-center gap-3">
          ...
          <a
            href="/pricing"
            className="ml-auto text-xs text-orange-400 font-bold hover:underline whitespace-nowrap"
          >
            Ver planes →
          </a>
        </div>
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setForm({
                      ...form,
                      min_discount_percent: parseInt(e.target.value, 10),
                    })
                  }
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setForm({
                      ...form,
                      min_profit: parseInt(e.target.value, 10),
                    })
                  }
                  className="w-full accent-neon-green"
                />
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setForm({
                      ...form,
                      max_distance_miles: parseInt(e.target.value, 10),
                    })
                  }
                  className="w-full accent-neon-green"
                />
            ...
            <div className="flex items-center gap-6">
              ...
              >
                ...
                <span className="text-sm">
                  WhatsApp{' '}
                  {user?.plan !== 'elite' && (
                    <span className="text-xs text-yellow-400">(Elite)</span>
                  )}
                </span>
              </label>
            </div>
      ...
      <div className="space-y-3">
        {alerts.length === 0 ? (
          ...
          alerts.map((alert) => (
            <div
              key={alert.id}
              className={`card p-4 ${!alert.is_active ? 'opacity-60' : ''}`}
            >
